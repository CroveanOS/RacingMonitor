...
namespace RM.Server.Controls
{
    ...
    public class SerialSettings : INotifyPropertyChanged
    {
        ...
        public void GetSettings()
        {
            ...
            _baudRate = Convert.ToInt32(Properties.Settings.Default.BaudRate);
            _dataBits = Convert.ToInt32(Properties.Settings.Default.DataBits);
            _parity = (Parity)Enum.Parse(typeof(Parity), Properties.Settings.Default.Parity, true);
            _stopBits = (StopBits)Enum.Parse(typeof(StopBits), Properties.Settings.Default.StopBits, true);
        }
        ...
        /// </summary>
        public int[] DataBitsCollection { get; set; } = { 5, 6, 7, 8 };
